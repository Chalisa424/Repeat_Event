...
('Education', 'Tech Workshop', 'Learn the basics of coding in a fun environment.', 'City Library', '2023-10-05', '14:00', FALSE, 'Tech for All'),
('Food', 'Farmers Market', 'Fresh produce and local goods every weekend.', 'Market Square', '2023-10-21', '09:00', TRUE, 'Local Farmers Association'),
('Theater', 'Outdoor Play', 'Enjoy a classic play performed under the stars.', 'Open Air Theater', '2023-10-28', '19:30', FALSE, 'City Theater Group');